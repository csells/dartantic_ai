...
Create your own providers and use them like the built-in providers. Your provider can expose a `ChatModel`, an `EmbeddingsModel` or both.
...
If you'd like to participate in the named lookup of providers, you can add your custom provider to the provider map:
