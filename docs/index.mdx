...
- **8 built-in providers**: OpenAI, OpenAI Responses, Google (Gemini),
  Anthropic (Claude), Mistral, Cohere, Ollama, OpenRouter
- **Extensible**: Register custom providers or use the `openai_compat.dart`
  example for Together AI, Google-OpenAI, and Ollama-OpenAI
- **Chat + Embeddings**: OpenAI, OpenAI Responses, Google, Mistral, Cohere all
  support both
- **Extended Thinking**: OpenAI Responses, Anthropic, and Google all support
  exposing model reasoning alongside responses
- **Server-side tools**: OpenAI Responses, Google, and Anthropic expose
