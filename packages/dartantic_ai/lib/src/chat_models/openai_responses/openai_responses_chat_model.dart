...
class OpenAIResponsesChatModel
  ...
  /// Timeout for downloading container files generated by code interpreter.
  ///
  /// Container files can be large (plots, data files, etc.) but should
  /// complete within a reasonable timeframe. This prevents indefinite hangs
  /// while allowing sufficient time for legitimate large file transfers.
  static const _containerFileDownloadTimeout = Duration(seconds: 60);
  ...
  Future<ContainerFileData> downloadContainerFile(
    ...
    final bytes = await _client
        ...
        .timeout(
          _containerFileDownloadTimeout,
          onTimeout: () => throw TimeoutException(
            'Container file download timed out after '
            '${_containerFileDownloadTimeout.inSeconds}s: $fileId',
          ),
        );
